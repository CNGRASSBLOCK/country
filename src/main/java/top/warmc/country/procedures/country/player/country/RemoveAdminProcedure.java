...
//
//public class RemoveAdminProcedure {
...
//		if (!CountryModVariables.country_admin.contains(the_player_uuid)) {
//			if (entity instanceof Player _player && !_player.level().isClientSide())
//				_player.displayClientMessage(Component.literal("\u00A76[Country]\u00A73[player]\u00A7c\u6B64\u4EBA\u4E0D\u662F\u7BA1\u7406\u5458!"), false);
//			return InteractionResult.SUCCESS;
//		}
//		admin_list.remove(the_player_uuid);
//		CountryModVariables.country_admin.set((int) number_for_my_country, admin_list);
//		if (entity instanceof Player _player && !_player.level().isClientSide())
//			_player.displayClientMessage(Component.literal("\u00A76[Country]\u00A73[player]\u00A72\u79FB\u9664\u6210\u529F!"), false);
//		return InteractionResult.SUCCESS;
//	}
//}
